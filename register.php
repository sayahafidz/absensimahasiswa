                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="register_proses.php">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="nim" placeholder="NIM">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="kelas" placeholder="Kelas">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name="program_studi" placeholder="Program Studi">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="text-center p">
                                <a class="small" href="login.php">Udah punya akun? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
